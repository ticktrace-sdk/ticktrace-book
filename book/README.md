...
> "Every cycle matters.", the ticktrace motto.
...
1. Understand what a CPU register is, what memory-mapped I/O is, and what an
   instruction set is.
2. Read and write ARM Thumb-2 assembly fluently enough to follow the ticktrace
   source tree.
...
4. Write programs that talk to the outside world over UART, blink LEDs,
   handle timer interrupts, and coordinate with the ticktrace driver library.
...
ticktrace is, to our knowledge, the only fully-featured SDK for the RP2350
...
The second half, chapters 7–12, explains the ticktrace idioms in depth and
...
| 5 | [Setting up ticktrace](05-setting-up-rp-asm.md) | build pipeline |
